...
<div class="page" style="page-break-after:always;">
  ...
  <table style="width:100%;border-collapse:collapse;font-size:12px;">
    ...
    <tbody>
      ${tocRow(b('#38bdf8', 'PART I'), '<strong>50-Day Foundation</strong> &mdash; Master Timeline', 'Jul 13 - Sep 14', 'overview', false)}
      ...
      <tr><td style="padding:6px 9px;border-bottom:1px solid #f1f5f9;background:#fef9c3;">${b('#eab308', 'RESET')}</td><td style="padding:6px 9px;border-bottom:1px solid #f1f5f9;background:#fef9c3;"><a href="#js-reset" style="color:inherit;text-decoration:none;display:block;"><strong>JS Reset / Revision Week</strong> &mdash; revise P1-3, warm up JS</a></td><td style="padding:6px 9px;border-bottom:1px solid #f1f5f9;background:#fef9c3;color:#78350f;">Jul 20-26, 2026</td></tr>
      ${tocRow('', 'Phase 4: JavaScript Basics Warm-up', 'Jul 27-28', 'phase-4', true)}
      ${tocRow('', 'Phase 5: Advanced JavaScript + OOP', 'Jul 29 - Aug 1', 'phase-5', false)}
      ${tocRow('', 'Phase 6: React + Tailwind CSS', 'Aug 3-8', 'phase-6', true)}
      ${tocRow('', 'Phase 7: Node.js + Express (Deep Dive)', 'Aug 10-18', 'phase-7', false)}
      ${tocRow('', 'Phase 8: REST API Design', 'Aug 19-23', 'phase-8', true)}
      ${tocRow('', 'Phase 9: MySQL + Node Integration', 'Aug 24 - Sep 1', 'phase-9', false)}
      ${tocRow('', 'Phase 10: Git (Advanced) + Docker + AWS', 'Sep 2-5', 'phase-10', true)}
      ${tocRow('', 'Full-Stack Capstone A &mdash; Deploy the Auth API', 'weekends + breaks', 'capstone-a', false)}
      ${tocRow('', 'Phase 11: System Design Fundamentals', 'Sep 6-9', 'phase-11', true)}
      ${tocRow('', 'Full-Stack Capstone B &mdash; Scale + Portfolio Polish', 'final weekends', 'capstone-b', false)}
      ${tocRow('', 'Phase 12: Agentic AI + n8n + FocusTrack Pro', 'Sep 10-14', 'phase-12', true)}
      ${tocRow('', 'Agentic Capstone C &mdash; Personal Research Agent', 'final weekends', 'capstone-c', false)}
      ${tocRow('', 'Agentic Capstone D &mdash; RAG Assistant + Automations', 'final weekends', 'capstone-d', true)}
      ${tocRow(b('#0891b2', 'PART II'), '<strong>Part II Overview</strong> &mdash; SAP Ecosystem + ABAP Institute', 'Sep 15 &rarr; end Nov / mid Dec', 'part2-overview', false)}
      ${tocRow('', 'Phase A: SAP Overview &amp; Ecosystem (self-study)', 'Sep 15-17', 'phase-A', true)}
